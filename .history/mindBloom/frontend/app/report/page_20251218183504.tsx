        ...
        <section className="mb-12 p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-blue-50/80 via-purple-50/70 to-pink-50/80 backdrop-blur-2xl border border-purple-200/60 shadow-2xl animate-in fade-in slide-in-from-top-4 duration-700">
          <div className="text-center mb-8">
            <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center text-5xl">
              {/* Lotus Icon */}
              <svg className="w-14 h-14 text-pink-500" viewBox="0 0 24 24" fill="currentColor">
                 <path d="M12 2.25c0 0 2.6 4.6 4.3 6.9 1.5 2 3.7 3.1 3.7 5.6 0 2.5-1.9 4.4-4.3 4.4-1.6 0-3-.9-3.7-2.2-.7 1.3-2.1 2.2-3.7 2.2-2.4 0-4.3-1.9-4.3-4.4 0-2.5 2.2-3.6 3.7-5.6 1.7-2.3 4.3-6.9 4.3-6.9z" opacity="0.6" />
                 <path d="M12 22.5c0 0-1.5-3-1.5-5.5 0-2.5 1.5-4 1.5-4s1.5 1.5 1.5 4c0 2.5-1.5 5.5-1.5 5.5z" />
              </svg>
            </div>
