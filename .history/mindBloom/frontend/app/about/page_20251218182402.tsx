  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h.5A2.5 2.5 0 0016 5.5V3.935m0 2.946a24.881 24.881 0 016.15-1.846c.356-.09.666-.009.966.227.242.214.579.16.864-.015l2.4-1.657c.142-.098.282-.06.38.057.099.118.06.203-.042.289l-1.494 1.994c-.233.312-.282.704-.096 1.05.382.707.451 1.829.242 3.654-.504 4.76-7.224 8.45-12.318 5.037C7.241 15.969 2.5 10.657 2.5 5.5a3.5 3.5 0 015.555-3.285"
                      />
                    </svg>
        ...
        {/* Support Resources - ICONS PRESERVED */}
