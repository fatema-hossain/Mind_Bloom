...
export default function AssessmentPage() {
  ...
  >
    ...
    {step === i && (
      ...
      {/* Admin Test Button - Discreet dot in bottom-right corner */}
      {isAdmin && (
        <div className="fixed bottom-4 right-4 z-50">
          <div className="relative">
            <button
              onClick={() => setShowTestMenu(!showTestMenu)}
              className="w-3 h-3 rounded-full bg-slate-400/50 hover:bg-slate-500/70 transition-all duration-200 hover:scale-150"
              title="Admin Test Mode"
              aria-label="Toggle admin test menu"
            />
            
            {showTestMenu && (
              <div className="absolute bottom-6 right-0 p-2 bg-white/95 backdrop-blur-sm rounded-xl shadow-xl border border-slate-200 min-w-[140px] animate-in fade-in slide-in-from-bottom-2 duration-200">
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 px-2">Quick Test</p>
                <button
                  onClick={() => loadTestPreset("low")}
                  className="w-full text-left px-3 py-1.5 text-xs font-medium rounded-lg hover:bg-green-50 text-green-700 transition-colors flex items-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-1.5 text-xs font-medium rounded-lg hover:bg-yellow-50 text-yellow-700 transition-colors flex items-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-1.5 text-xs font-medium rounded-lg hover:bg-red-50 text-red-700 transition-colors flex items-center gap-2"
                >
