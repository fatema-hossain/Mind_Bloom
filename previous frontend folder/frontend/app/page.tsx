  ...
  return (
    <div className="space-y-6">
      <div className="mb-4 p-3 bg-blue-50 border-l-4 border-blue-500 rounded-r-xl">
        <p className="text-sm text-slate-700"><span className="font-semibold">Quick Assessment:</span> Only ~20 questions needed for accurate risk assessment</p>
      </div>
      {/* Personal Details */}
...
function Step2({ form, updateField }: any) {
  return (
    <div className="space-y-6">
      {/* Pregnancy Details */}
      <div className="p-6 bg-gradient-to-br from-pink-50/90 via-purple-50/80 to-blue-50/90 rounded-2xl border-2 border-purple-200/70 shadow-lg relative overflow-visible">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-bold text-pink-800">Pregnancy Details</h3>
